    ...
    <form className="my-10 ">
      ...
      <div className="my-5">
        ...
        <label className="form-control w-full max-w-xs">
          <div className="label">
            <span className="label-text">
              2. Email memakai penggunaan tanda baca yang baik*
            </span>
        ...
        <label className="form-control w-full max-w-xs">
          <div className="label">
            <span className="label-text">
             3. Penulisan konten Ticket di Zendesk*
            </span>
            <span className="label-text">(Bobot 5)</span>
          </div>
          <div className="flex space-x-4">
        ...
        <label className="form-control w-full max-w-xs">
          <div className="label">
            <span className="label-text">
              4. CCO menggunakan etika dan bahasa Service yang baik *
            </span>
        ...
        <label className="form-control w-full max-w-xs">
          <div className="label">
            <span className="label-text">5. Penjelasan yang diberikan oleh CSO sesuai dengan sumber informasi lainnya (Accuracy), lengkap dan dengan analisa yang benar*</span>
            <span className="label-text">(Bobot 25)</span>
          </div>
          <div className="flex space-x-4">
            <input
              type="text"
        ...
        <label className="form-control w-full max-w-xs">
          <div className="label">
            <span className="label-text">6. Solusi yg diberikan lengkap dan tuntas *</span>
            <span className="label-text">(Bobot 25)</span>
          </div>
          <div className="flex space-x-4">
            <input
